                ...
                Flexible(
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        //Datetime
                        DateTime entryTime =
                            (eachOuterStoryDocument['dateTime'] as Timestamp)
                                .toDate();

                        String title = eachOuterStoryDocument['title'];
                        String story = eachOuterStoryDocument['story'];
                        List<dynamic> tags = eachOuterStoryDocument['tag'];

                        List<dynamic> group = eachOuterStoryDocument
